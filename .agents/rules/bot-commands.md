...
When modifying the `what-watch-bot` repository, you must adhere to the following constraints to guarantee alignment between the OpenClaw wizard and Telegram BotFather commands.
