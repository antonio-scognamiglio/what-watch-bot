...
- **Validation Check**: You MUST verify that your code works by running the full test suite (`pytest tests/`) and ensuring all tests pass BEFORE proposing a commit.
